...
Construo interfaces web com HTML semântico, CSS moderno e JavaScript/TypeScript.
Foco em código legível, acessibilidade e performance.
...
Sou desenvolvedor front-end em São Paulo, em busca da primeira oportunidade profissional
(estágio ou júnior). Comecei pelos fundamentos — HTML5, CSS3 e JavaScript — construindo cada
projeto do zero para entender o que acontece por baixo do framework, e hoje aplico essa base
no desenvolvimento de interfaces com React e TypeScript.

- Trabalho com **componentização**, **tipagem estática** e **consumo de APIs REST**.
- Trato **acessibilidade (WCAG)** e **responsividade** como requisitos, não como extras.
- Tenho projetos próprios em **Python** para automação, o que me dá repertório para conversar sobre back-end.
- Documento cada repositório com um README explicando o problema, as decisões técnicas e como executar.
...
| [**projeto-cordel**](https://github.com/nicolasmoreiraferreira/projeto-cordel) | Página editorial com efeito parallax em CSS e tipografia pensada para leitura. [Demo](https://nicolasmoreiraferreira.github.io/projeto-cordel/) | HTML, CSS |
| [**HTML-CSS**](https://github.com/nicolasmoreiraferreira/HTML-CSS) | Mais de 26 exercícios e 10 desafios: CSS Grid, Media Queries, iframes e variáveis CSS. | HTML5, CSS3 |
| [**JAVASCRIPT**](https://github.com/nicolasmoreiraferreira/JAVASCRIPT) | Exercícios de lógica, DOM, eventos, funções e temporizadores. | JavaScript |
...
- **LinkedIn:** <!-- TODO-LINKEDIN --> [adicionar link do LinkedIn](https://www.linkedin.com/in/)
- **E-mail:** <!-- TODO-EMAIL --> substituir pelo endereço real
